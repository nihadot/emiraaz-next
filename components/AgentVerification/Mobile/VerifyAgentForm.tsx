  ...
  return (
    <div className="min-h-screen bg-white px-4 pt-4 pb-28">
      ...
      <div className="rounded-2xl border border-gray-200 px-5 py-6 text-center">
        ...
        <p className="mt-3 text-[13px] leading-[18px] text-gray-500">
      ...
      >
        {({ isSubmitting }) => (
          <Form className="mt-6 space-y-2">
            <label
              htmlFor="agentId"
              className="block text-[13px] font-medium text-gray-800"
            >
              Agent ID
            </label>
            ...
            <InputField
              ...
              className="h-12 rounded-xl border border-gray-200 px-4 text-[14px] placeholder:text-gray-400"
            />
