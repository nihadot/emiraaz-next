...
function Footer() {
    ...
    const appUrl = 
        {
            appStore:'https://apps.apple.com/us/app/propertyseller/id6738964688',
            googlePlay:'https://play.google.com/store/apps/details?id=com.propertyseller.app'
        }
        ...
        <>
            ...
            <footer className='bg-black'>
                ...
                <Container>
                    ...
                    <section className=' flex gap-0 sm:gap-10  flex-col lg:flex-row w-full pt-10 pb-3 sm:py-10 '>
...
>
                ...
                <Container>
                    ...
                    <div className="flex items-center w-full justify-center sm:justify-between">
                        <div className="sm:flex py-5 self-end hidden items-center gap-2">
                            <Image
                                className='w-[28.5px] h-[28.5px] object-cover'
                                src={trademark}
                                alt='trademark'
                            />
                            <p className='text-[10.5px] font-poppins font-medium text-white'>Trademark Registered</p>
                        </div>

                        <p className='flex gap-1 justify-center py-5 self-end items-center'>
                        ...
                        <div className="sm:flex hidden mb-3 items-center gap-2">
                            <a href="https://www.emiraaz.com/" target='_blank'>
                                <Image
                                className='w-[173px] h-[76px] object-cover'
                                src={byEmiraaz}
                                alt='trademark'
