            ...
            <div className=" max-w-[1200px] mx-auto w-full lg:overflow-visible font-[family-name:var(--font-geist-sans)]">
                ...
                <Container>
                    ...
                    >
                        ...
                        <p className='text-[22.5px] mb-[16px] font-medium text-black font-poppins'>Explore Help Topics</p>
...
function HelpTopics({
    ...
    return (
        <div className='rounded-[6px] p-[25.5px]  border  border-[#DEDEDE] h-[238px]'>
            <div className="flex justify-start mb-2 gap-[12px]">
                <div className="">{icon}</div>
                <h3 className='font-poppins font-medium text-[20px]'>{title}</h3>
            </div>
            {
                options.map((option, index) => (
                    <div key={index} className="flex justify-between items-center py-[4px] underline">
                        <p className='font-poppins text-[12px] font-normal text-[#333333] '>{option}</p>
            ...
            <div className="flex  items-center gap-[9px] mt-2">
                <p className='text-[12px] text-[#FF1645] font-poppins'>View More</p>
                <div className="">
                    <IoChevronDown
                        color='#FF1645'
...
function ToggleButton({ title, children }: {
    ...
    return (
        <div className="border-[#DEDEDE] mt-[11px] rounded-[5px] border-[1.5px] overflow-hidden">
            ...
            >
                <p className="font-poppins font-medium capitalize text-[14px] sm:text-[16px] text-black">
                    {title}
                </p>
                {isOpen ? (
