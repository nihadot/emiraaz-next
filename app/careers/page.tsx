...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    ...
    const responseData = await fetch(
      `${baseUrl}/meta-data?referencePage=careers`,
      {
        next: {
    ...
    return {
      ...
      openGraph: {
        ...
        url: data?.openGraphUrl || "https://www.propertyseller.com/careers",
      ...
      alternates: {
        canonical: data.canonical || "https://www.propertyseller.com/careers"
      }
    }
  } catch (error) {
    ...
    return {
      ...
      openGraph: {
        ...
        url: "https://www.propertyseller.com/careers",
      ...
      alternates: {
        canonical: "https://www.propertyseller.com/careers",
      },
    }
  }
}
