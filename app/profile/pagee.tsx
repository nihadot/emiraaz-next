    ...
    <main>
      <div className="w-full font-[family-name:var(--font-geist-sans)]">
        ...
        <Container>
          ...
          <div className=" mt-[30px] mb-32 flex  flex-col  items-center md:items-start ">

            <p className='text-[28.5px] mb-[16px] mt-[16px] sm:mb-[17px] font-poppins font-medium'>
              Your Profile
            </p>
            ...
            <div className="pt-[16px] sm:pt-[28px] pb-0 m-0 max-w-[372.75px] w-full">
              ...
              <div className='mt-[12.75px] flex flex-col gap-[7.5px] font-poppins'>
                <label className=' text-[10.5px] font-poppins sm:text-[13.5px]  font-medium'>Phone</label>
                <div className="border w-full border-[#DEDEDE] rounded px-4 font-poppins text-[11px] sm:text-[13.5px] font-medium py-2">
                  {user?.number}
                </div>
              </div>

              <div className='mt-[12.75px] flex flex-col gap-[7.5px] font-poppins'>
                <label className=' text-[10.5px] font-poppins sm:text-[13.5px]  font-medium'>Email</label>
                <div className="border w-full border-[#DEDEDE] rounded px-4 font-poppins text-[11px] sm:text-[13.5px] font-medium py-2">
                  {user?.email}
                </div>
              </div>
