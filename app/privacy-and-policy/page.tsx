...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    ...
    const responseData = await fetch(
      `${baseUrl}/meta-data?referencePage=privacy-and-policy`,
      {
        next: {
    ...
    return {
      ...
      openGraph: {
        ...
        url: data?.openGraphUrl || "https://www.propertyseller.com/privacy-and-policy",
      ...
      alternates: {
        canonical: data.canonical || "https://www.propertyseller.com/privacy-and-policy"
      }
    }
  } catch (error) {
    ...
    return {
      ...
      openGraph: {
        ...
        url: "https://www.propertyseller.com/privacy-and-policy",
      ...
      alternates: {
        canonical: "https://www.propertyseller.com/privacy-and-policy",
      },
    }
  }
}
