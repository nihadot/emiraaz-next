  ...
  try {
    ...
    return {
      ...
      openGraph: {
        ...
        url: data?.openGraphUrl || "https://www.propertyseller.com/open-house",
    ...
    return {
      ...
      openGraph: {
        ...
        url: "https://www.propertyseller.com/open-house",
      ...
      alternates: {
        canonical: "https://www.propertyseller.com/open-house",
      },
    }
  }
}
