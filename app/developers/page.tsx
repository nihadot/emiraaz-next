...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        return {
            title: data.metaTitle || "Developers | Property Seller - Trusted Off-Plan Real Estate Marketplace",
            ...
            keywords: data.keywords || 'property, real estate, developers',
            openGraph: {
                title: data.openGraphTitle || "Developers | Simplifying Real Estate Investments",
                ...
                url: data?.openGraphUrl || "https://www.propertyseller.com/developers",
                siteName: data?.siteName || "Developers | Property Seller",
                images: [
                    {
                        url: data?.metaImage?.url || "https://res.cloudinary.com/dknxmloqh/image/upload/v1748991060/favicon-DBW5gi7l_j0cjdz.png",
                        width: 1200,
                        height: 630,
                        alt: data?.metaImage?.openGraphTitle || "Developers - Connecting Buyers with Trusted Developers",
                    },
                ],
                type: data?.type || "website",
            },
            twitter: {
                title: data.twitterTitle || 'Developers | Property Seller',
            ...
            alternates: {
                canonical: data.canonical || "https://www.propertyseller.com/developers"
            }
        }
    } catch (error) {
        ...
        return {
            ...
            openGraph: {
                ...
                url: "https://www.propertyseller.com/developers",
            ...
            alternates: {
                canonical: "https://www.propertyseller.com/developers",
            },
        }
    }
}
