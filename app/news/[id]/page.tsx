                ...
                <div className="mb-20">
                    ...
                    <div className="flex items-start gap-[27.5px] justify-center">
                        ...
                        <div className="w-full h-full">
                            <p className='text-[12px] w-full font-poppins font-normal mt-[16px] '>{singleNews?.data?.newsBody}</p>
                                    ...
                                    allNews?.data.map((item, index) => {
                                        return (
                                            <div key={index}  className="flex items-center flex-col gap-[10.5px] ">
                                                <div className="relative w-full h-[208.5px] rounded-[3.75px] object-cover">
                                                    <div className="px-3 py-1 absolute z-30 left-[15px] top-[13.5px] text-[#FF1645] bg-red-700/10 ">{item?.newCategoryDetails?.name}</div>
                                                ...
                                                <div className="flex flex-col ">
                                                        ...
                                                        <div className="flex items-center mb-[6px] gap-[4.5px]">
                                                            <p className='text-[#767676]   text-[12px] font-medium font-poppins'>Date Published{formatDate(item?.date)}</p>
                                                        </div>
