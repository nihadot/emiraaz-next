...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        const responseData = await fetch(
            `${baseUrl}/meta-data?referencePage=cities`,
            {
                next: {
        ...
        return {
            ...
            openGraph: {
                ...
                url: data?.openGraphUrl || "https://www.propertyseller.com/cities",
            ...
            alternates: {
                canonical: data.canonical || "https://www.propertyseller.com/cities"
            }
        }
    } catch (error) {
        ...
        return {
            ...
            openGraph: {
                ...
                url: "https://www.propertyseller.com/cities",
            ...
            alternates: {
                canonical: "https://www.propertyseller.com/cities",
            },
        }
    }
}
