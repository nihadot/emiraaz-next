...
export const buyProjectApi = createApi({
  reducerPath: "buyProjectApi",
  baseQuery: baseQueryWithReAuth,
  tagTypes: ["BuyProjects", "AllBuyProjects"],
  endpoints: (builder) => ({
    fetchAllBuyProjects: builder.query<ViewProjectResponse, {
      page?: number,
      limit?: number,
      search?: string,
      propertyType?: string[],
      ...
      providesTags: ["BuyProjects"],
    }),
  }),
});

export const {
  useFetchAllBuyProjectsQuery,
} = buyProjectApi;
